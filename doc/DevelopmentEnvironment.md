...
```bash
[!] Flutter (Channel stable, 3.13.9, on Microsoft Windows [版本 10.0.19043.1586], locale zh-CN)
    • Flutter version 3.13.9 on channel stable at C:\Users\moli\fvm\default
